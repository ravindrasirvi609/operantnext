...
const CourseSidemenu = () => {
  return (
    <div className="w-full h-full bg-lime-200 dark:bg-zinc-800 p-4">
      <div className="flex items-center mb-6">
        <div className="w-12 h-12 bg-zinc-300 rounded-full"></div>
        <div className="ml-4">
          <h1 className="text-xl font-bold dark:text-white">Design Academy</h1>
        ...
        <ul>
          ...
          <li className="mb-2">
            ...
            >
              ...
              <span className="ml-4 rounded-full  px-2 py-1 bg-red-500">
                {" "}
                1{" "}
              </span>
            </a>
